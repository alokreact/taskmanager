...
<div class="container">
   ...
   <form method="POST" action="/jobcreate">
   {{csrf_field()}}
   
    <div class="form-group col-md-12">
    <label for="inputEmail4">PositionTitle</label>
<input type="text" class="form-control" id="inputEmail4" name ="title" placeholder="Title">
    </div>
   <!--<input type="text" name="email">
       <input type="text" name="desc"> -->
    <div class="form-group col-md-12">
    <label for="inputEmail4">Job Desc</label>                
    <textarea id="full-featured"  name="desc"></textarea>
    </div>                  
...
<input type="text" class="form-control" id="inputEmail4" name ="salary" placeholder="Title">
</div>
<div class="form-group col-md-12">
<label for="inputEmail4">Location</label>
<input type="text" class="form-control" id="inputEmail4" name ="location" placeholder="Title">
</div>
