...
<link href="{{asset('css/vendor/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet">
	...
	<i class="fas fa-fw fa-bell"></i> <span class="indicator"></span></a>
	...
	<img src="{{asset('images/avatar-2.jpg')}}" alt="" class="user-avatar-md rounded-circle"></div>
	...
	<div class="notification-info">
	<div class="notification-list-user-img">
	<img src="{{asset('images/avatar-3.jpg')}}" alt="" class="user-avatar-md rounded-circle">
	</div>
	...
	<img src="{{asset('images/avatar-4.jpg')}}" alt="" class="user-avatar-md rounded-circle">
	</div>
	...
	<div class="notification-info">
	<div class="notification-list-user-img">
	<img src="{{asset('images/avatar-5.')}}jpg" alt="" class="user-avatar-md rounded-circle">
	</div>
	<div class="notification-list-user-block">
	...
	<img src="{{asset('images/github.png')}}" alt="" > <span>Github</span></a>
	</div>

	<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 ">
	<a href="#" class="connection-item">
	<img src="{{asset('images/dribbble.png')}}" alt="" > <span>Dribbble</span>
	</a>
	</div>
	<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 ">
	<a href="#" class="connection-item"><img src="{{asset('images/dropbox.p')}}ng" alt="" > <span>Dropbox</span></a>
	</div>
	</div>
	<div class="row">
	<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 ">
	...
	<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 ">
	<a href="{{route('jobform')}}" class="connection-item">
	<img src="{{asset('images/mail_chimp.png')}}" alt="" ><span>Add Job</span></a>
	</div>
	...
	<img src="{{asset('images/avatar-1.jpg') }}" alt="" class="user-avatar-md rounded-circle"></a>
	...
	<li class="nav-item">
	<a class="nav-link" href="{{route('jobform')}}" data-toggle="collapse" aria-expanded="false" data-target="#" aria-controls="submenu-3">
	<i class="fas fa-fw fa-chart-pie"></i>Add Job</a>
	...
	<p> <input type="text" name="" id="name"  class="form-control"> </p>
	...
	<div class="card">
	<div class="card-body">
	<h5 class="text-muted"><a href="{{route('jobdashboard')}}">Total Active Jobs</a></h5>
	...
	<button class="btn btn-info btn-sm" data-toggle="modal" data-mytitle="{{$task->title}}"
	data-myname="{{$task->user}}" data-target="#myModal" data-href="" id="edit-modal">
	Edit</button>
...
<script type="text/javascript" src="{{ asset('js/vendor/jquery/jquery-3.3.1.min.js') }}">
</script>
	<script type="text/javascript" src="{{ asset('js/vendor/bootstrap/js/bootstrap.bundle.js') }}">
	</script>

	<script type="text/javascript" src="{{ asset('js/vendor/slimscroll/jquery.slimscroll.js') }}"></script>

<script type="text/javascript" src="{{ asset('js/libs/js/main-js.js') }}"></script>
	
	<script type="text/javascript" src="{{ asset('js/vendor/charts/chartist-bundle/chartist.min.js') }}"></script>

	<script src="{{ asset('js/vendor/charts/sparkline/jquery.sparkline.js')}}"></script>

	<script type="text/javascript" src="{{ asset('js/vendor/charts/morris-bundle/raphael.min.js') }}">
	</script>

	<script type="text/javascript" src="{{ asset('js/vendor/charts/morris-bundle/morris.js') }}">
	</script>

	<script type="text/javascript" src="{{ asset('js/vendor/charts/c3charts/c3.min.js') }}"></script>
	<script type="text/javascript" src="{{ asset('js/vendor/charts/c3charts/d3-5.4.0.min.js') }}"></script>

	<script type="text/javascript" src="{{ asset('js/vendor/charts/c3charts/C3chartjs.js') }}"></script>

	<script type="text/javascript" src="{{ asset('js/libs/js/dashboard-ecommerce.js') }}">
	...
	console.log(title);
	var moadl =$(this);
	moadl.find('.modal-body #title').val(title);
	moadl.find('.modal-body #name').val(name);
	//alert(title);
	});
