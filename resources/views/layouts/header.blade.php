...
<body>
   ...
   <img src="assets/images/avatar-4.jpg" alt="" class="user-avatar-md rounded-circle"></div>
   ...
   <div class="notification-date">2 min ago</div>
    ...
    <a class="nav-link" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="fas fa-fw fa-th"></i> </a>
      ...
      <img src="assets/images/mail_chimp.png" alt="" ><span>Add Job</span></a>
      </div>
      <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 ">
...
<li class="nav-item">
   <a class="nav-link" href="pages/tabs.html">Tabs</a>
      ...
      <li class="nav-item">
      <a class="nav-link" href="{{route('jobform')}}" data-toggle="collapse" aria-expanded="false" data-target="#submenu-3" aria-controls="submenu-3">
 ...
 <div class="container-fluid dashboard-content ">
    ...
    <div class="row">
      ...
      <div class="card">
      <div class="card-body">
      <h5 class="text-muted">Total Active Jobs</h5>
...
<button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal">Complete</button>

 <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModal">Incomplete</button>
<!-- Modal -->
...
<button type="button" class="btn btn-primary">Save changes</button>
    ...
    <li class="list-group-item country-sales-content"><span class=" mr-2">
          <i class="flag-icon flag-icon-fr" title="fr" id="fr"></i></span>
          <span class="">France</span><span class="float-right text-dark">16%</span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="card-footer text-center">
